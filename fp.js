(function () {
    ...
    function getBraveMode() {
        ...
        try {
            ...
            const hasChromePlugins = pluginsList.filter((plugin) => chromePlugins.test(plugin.name)).length ==
                2;
...
`;
    ...
    function getSessionID() {
        let sessionData = sessionStorage.getItem("browsify_session_data");
        if (sessionData) {
            sessionData = JSON.parse(sessionData);
            const currentTime = Date.now();
            const sessionExpiration = sessionData.timestamp + 30 * 60 * 1000;
            if (currentTime > sessionExpiration) {
                ...
                sessionStorage.setItem("browsify_session_data", JSON.stringify(newSessionData));
                return newSessionID;
            }
            else {
...
`;
    ...
    async function cipher(data) {
        ...
        let keyData = '';
        if (k) {
            keyData = k.split('').reverse().join('');
        }
        const m1 = message.substring(8);
        const m2 = message.substring(0, 8);
        return [m1, m2 + vector, rds(16) + keyData];
    }
    ...
    async function getCanvas2d() {
        try {
            ...
            let textMetricsLie = (lieProps['CanvasRenderingContext2D.measureText'] ||
                ...
                lieProps['TextMetrics.width']) ? true : false;
            let lied = (dataLie ||
                contextLie ||
                imageDataLie ||
                textMetricsLie ||
    ...
    async function getClientRects() {
        try {
            ...
            const base64ByteArray = [67, 103, 107, 74, 80, 71, 82, 112, 100, 105, 66, 112, 90, 68, 48, 105, 88, 49, 57, 83, 82, 85, 78, 85, 85, 48, 108, 69, 88, 49, 56, 105, 80, 103, 111, 74, 67, 81, 107, 56, 99, 51, 82, 53, 98, 71, 85, 43, 67, 103, 107, 74, 67, 83, 53, 121, 90, 87, 78, 48, 76, 87, 100, 111, 98, 51, 78, 48, 76, 65, 111, 74, 67, 81, 107, 117, 99, 109, 86, 106, 100, 67, 49, 114, 98, 109, 57, 51, 98, 105, 66, 55, 67, 103, 107, 74, 67, 81, 108, 48, 98, 51, 65, 54, 73, 68, 65, 55, 67, 103, 107, 74, 67, 81, 108, 115, 90, 87, 90, 48, 79, 105, 65, 119, 79, 119, 111, 74, 67, 81, 107, 74, 99, 71, 57, 122, 97, 88, 82, 112, 98, 50, 52, 54, 73, 71, 70, 105, 99, 50, 57, 115, 100, 88, 82, 108, 79, 119, 111, 74, 67, 81, 107, 74, 100, 109, 108, 122, 97, 87, 74, 112, 98, 71, 108, 48, 101, 84, 111, 103, 97, 71, 108, 107, 90, 71, 86, 117, 79, 119, 111, 74, 67, 81, 108, 57, 67, 103, 107, 74, 67, 83, 53, 121, 90, 87, 78, 48, 76, 87, 116, 117, 98, 51, 100, 117, 73, 72, 115, 75, 67, 81, 107, 74, 67, 88, 100, 112, 90, 72, 82, 111, 79, 105, 65, 120, 77, 68, 66, 119, 101, 68, 115, 75, 67, 81, 107, 74, 67, 87, 104, 108, 97, 87, 100, 111, 100, 68, 111, 103, 77, 84, 65, 119, 99, 72, 103, 55, 67, 103, 107, 74, 67, 81, 108, 48, 99, 109, 70, 117, 99, 50, 90, 118, 99, 109, 48, 54, 73, 72, 74, 118, 100, 71, 70, 48, 90, 83, 103, 48, 78, 87, 82, 108, 90, 121, 107, 55, 67, 103, 107, 74, 67, 88, 48, 75, 67, 81, 107, 74, 76, 110, 74, 108, 89, 51, 81, 116, 90, 50, 104, 118, 99, 51, 81, 103, 101, 119
, 111, 103, 89, 87, 74, 122, 98, 50, 120, 49, 100, 71, 85, 103, 73, 87, 108, 116, 99, 71, 57, 121, 100, 71, 70, 117, 100, 68, 115, 75, 67, 81, 107, 74, 67, 81, 108, 48, 99, 109, 70, 117, 99, 50, 90, 118, 99, 109, 48, 54, 73, 72, 78, 106, 89, 87, 120, 108, 75, 68, 69, 117, 77, 68, 65, 119, 79, 84, 107, 53, 75, 84, 115, 75, 67, 81, 107, 74, 67, 88, 48, 75, 67, 81, 107, 74, 67, 84, 119, 118, 99, 51, 82, 53, 98, 71, 85, 43, 67, 103, 107, 74, 67, 81, 108, 102, 88, 48, 86, 78, 84, 48, 112, 74, 85, 49, 57, 102, 67, 103, 107, 74, 67, 84, 119, 118, 90, 71, 108, 50, 80, 103, 111, 74, 67, 84, 119, 118, 90, 71, 108, 50, 80, 103, 61, 61];
            const base64DivHtml = byteArrayToString(base64ByteArray);
            const divHtml = base64Decode(base64DivHtml).replace('__RECTSID__', rectsId).replace('__CSS_FONT_FAMILY__', CSS_FONT_FAMILY).replace('__EMOJIS__', EMOJIS.map((emoji) => `<div class="domrect-emoji">${emoji}</div>`).join(''));
            patch(divElement, html `${divHtml}`);
    ...
    */
    ...
    async function getFonts() {
        const getPixelEmojis = ({ doc, id, emojis }) => {
            try {
                const base64ByteArray = [80, 71, 82, 112, 100, 105, 66, 112, 90, 68, 48, 105, 99, 71, 108, 52, 90, 87, 119, 116, 90, 87, 49, 118, 97, 109, 107, 116, 89, 50, 57, 117, 100, 71, 70, 112, 98, 109, 86, 121, 73, 106, 52, 75, 67, 81, 107, 74, 67, 84, 120, 122, 100, 72, 108, 115, 90, 84, 52, 75, 67, 81, 107, 74, 67, 81, 107, 117, 99, 71, 108, 52, 90, 87, 119, 116, 90, 87, 49, 118, 97, 109, 107, 103, 101, 119, 111, 74, 67, 81, 107, 74, 67, 81, 108, 109, 98, 50, 53, 48, 76, 87, 90, 104, 98, 87, 108, 115, 101, 84, 111, 103, 88, 49, 57, 68, 85, 49, 78, 102, 82, 107, 57, 79, 86, 70, 57, 71, 81, 85, 49, 74, 84, 70, 108, 102, 88, 122, 115, 75, 67, 81, 107, 74, 67, 81, 107, 74, 90, 109, 57, 117, 100, 67, 49, 122, 97, 88, 112, 108, 79, 105, 65, 121, 77, 68, 66, 119, 101, 67, 65, 104, 97, 87, 49, 119, 98, 51, 74, 48, 89, 87, 53, 48, 79, 119, 111, 74, 67, 81, 107, 74, 67, 81, 108, 111, 90, 87, 108, 110, 97, 72, 81, 54, 73, 71, 70, 49, 100, 71, 56, 55, 67, 103, 107, 74, 67, 81, 107, 74, 67, 88, 66, 118, 99, 50, 108, 48, 97, 87, 57, 117, 79, 105, 66, 104, 89, 110, 78, 118, 98, 72, 86, 48, 90, 83, 65, 104, 97, 87, 49, 119, 98, 51, 74, 48, 89, 87, 53, 48, 79, 119, 111, 74, 67, 81, 107, 74, 67, 81, 108, 48, 99, 109, 70, 117, 99, 50, 90, 118, 99, 109, 48, 54, 73, 72, 78, 106, 89, 87, 120, 108, 75, 68, 69, 117, 77, 68, 65, 119, 79, 84, 107, 53, 75, 84, 115, 75, 67, 81, 107, 74, 67, 81, 108, 57, 67, 103, 107, 74, 67, 81, 107, 74, 80, 67, 57, 122, 100, 72, 108, 115, 90, 84, 52, 75, 67, 81, 107, 74, 67, 81, 108, 102, 88, 48, 86, 78, 84, 48, 112, 74, 85, 49, 57, 102, 67, 103, 107, 74, 67, 81, 107, 56, 76, 50, 82, 112, 100, 106, 52, 61];
                const base64DivHtml = byteArrayToString(base64ByteArray);
                const divHtml = base64Decode(base64DivHtml).replace('__CSS_FONT_FAMILY__', CSS_FONT_FAMILY).replace('__EMOJIS__', EMOJIS.map((emoji) => `<div class="pixel-emoji">${emoji}</div>`).join(''));
                patch(doc.getElementById(id), html `${divHtml}`);
                // get emoji set and system
    ...
    /* eslint-disable new-cap */
    async function getHeadlessFeatures({ webgl, }) {
        try {
            const timer = createTimer();
            await queueEvent(timer);
    ...
    async function getNavigator() {
        try {
            ...
            const userAgentDataBrands = () => attempt(() => {
                // @ts-ignore
                if (!navigator.userAgentData ||
                    // @ts-ignore
                    !navigator.userAgentData.getHighEntropyValues) {
                ...
                return navigator.userAgentData.getHighEntropyValues(['platform', 'platformVersion', 'architecture', 'bitness', 'model', 'uaFullVersion']).then((data) => {
                    // @ts-ignore
                    const { brands } = data || {};
                    return brands.map(e => `${e.brand} ${e.version}`).join(', ');
                });
            }, 'userAgentDataBrands failed');
            ...
            return Promise.all([
                ...
                getPermissions(),
                getWebGpu(),
            ]).then(([userAgentData, userAgentDataBrands, bluetoothAvailability, permissions, webgpu,]) => {
    ...
    async function getSVG() {
        try {
            ...
            const divElement = document.createElement('div');
            doc.body.appendChild(divElement);
            const base64ByteArray = [67, 103, 107, 74, 67, 84, 120, 107, 97, 88, 89, 103, 97, 87, 81, 57, 73, 110, 78, 50, 90, 121, 49, 106, 98, 50, 53, 48, 89, 87, 108, 117, 90, 88, 73, 105, 80, 103, 111, 74, 67, 81, 107, 74, 80, 72, 78, 48, 101, 87, 120, 108, 80, 103, 111, 74, 67, 81, 107, 74, 73, 51, 78, 50, 90, 121, 49, 106, 98, 50, 53, 48, 89, 87, 108, 117, 90, 88, 73, 103, 101, 119, 111, 74, 67, 81, 107, 74, 67, 88, 66, 118, 99, 50, 108, 48, 97, 87, 57, 117, 79, 105, 66, 104, 89, 110, 78, 118, 98, 72, 86, 48, 90, 84, 115, 75, 67, 81, 107, 74, 67, 81, 108, 115, 90, 87, 90, 48, 79, 105, 65, 116, 79, 84, 107, 53, 79, 88, 66, 52, 79, 119, 111, 74, 67, 81, 107, 74, 67, 87, 104, 108, 97, 87, 100, 111, 100, 68, 111, 103, 89, 88, 86, 48, 98, 122, 115, 75, 67, 81, 107, 74, 67, 88, 48, 75, 67, 81, 107, 74, 67, 83, 78, 122, 100, 109, 99, 116, 89, 50, 57, 117, 100, 71, 70, 112, 98, 109, 86, 121, 73, 67, 53, 122, 97, 71, 108, 109, 100, 67, 49, 122, 100, 109, 99, 103, 101, 119, 111, 74, 67, 81, 107, 74, 67, 88, 82, 121, 89, 87, 53, 122, 90, 109, 57, 121, 98, 84, 111, 103, 99, 50, 78, 104, 98, 71, 85, 111, 77, 83, 52, 119, 77, 68, 65, 53, 79, 84, 107, 112, 73, 67, 70, 112, 98, 88, 66, 118, 99, 110, 82, 104, 98, 110, 81, 55, 67, 103, 107, 74, 67, 81, 108, 57, 67, 103, 107, 74, 67, 81, 107, 117, 99, 51, 90, 110, 99, 109, 86, 106, 100, 67, 49, 108, 98, 87, 57, 113, 97, 83, 66, 55, 67, 103, 107, 74, 67, 81, 107, 74, 90, 109, 57, 117, 100, 67, 49, 109, 89, 87, 49, 112, 98, 72, 107, 54, 73, 70, 57, 102, 81, 49, 78, 84, 88, 48, 90, 80, 84, 108, 82, 102, 82, 107, 70, 78, 83, 85, 120, 90, 88, 49, 56, 55, 67, 103, 107, 74, 67, 81, 107, 74, 90, 109, 57, 117, 100, 67, 49, 122, 97, 88, 112, 108, 79, 105, 65, 121, 77, 68, 66, 119, 101, 67, 65, 104, 97, 87, 49, 119, 98, 51, 74, 48, 89, 87, 53, 48, 79, 119, 111, 74, 67, 81, 107, 74, 67, 87, 104, 108, 97, 87, 100, 111, 100, 68, 111, 103, 89, 88, 86, 48, 98, 122, 115, 75, 67, 81, 107, 74, 67, 81, 108, 119, 98, 51, 78, 112, 100, 71, 108, 118, 98, 106, 111, 103, 89, 87, 74, 122, 98, 50, 120, 49, 100, 71, 85, 103, 73, 87, 108, 116, 99, 71, 57, 121, 100, 71, 70, 117, 100, 68, 115, 75, 67, 81, 107, 74, 67, 81, 108, 48, 99, 109, 70, 117, 99, 50, 90, 118, 99, 109, 48, 54, 73, 72, 78, 106, 89, 87, 120, 108, 75, 68, 69, 117, 77, 68, 65, 119, 79, 84, 107, 53, 75, 84, 115, 75, 67, 81, 107, 74, 67, 88, 48, 75, 67, 81, 107, 74, 67, 84, 119, 118, 99, 51, 82, 53, 98, 71, 85, 43, 67, 103, 107, 74, 67, 81, 107, 56, 99, 51, 90, 110, 80, 103, 111, 74, 67, 81, 107, 74, 67, 84, 120, 110, 73, 71, 108, 107, 80, 83, 74, 122, 100, 109, 100, 67, 98, 51, 103, 105, 80, 103, 111, 74, 67, 81, 107, 74, 67, 81, 108, 102, 88, 48, 86, 78, 84, 48, 112, 74, 85, 49, 57, 102, 67, 103, 107, 74, 67, 81, 107, 74, 80, 67, 57, 110, 80, 103, 111, 74, 67, 81, 107, 74, 80, 67, 57, 122, 100, 109, 99, 43, 67, 103, 107, 74, 67, 84, 119, 118, 90, 71, 108, 50, 80, 103, 61, 61];
            const base64DivHtml = byteArrayToString(base64ByteArray);
            const divHtml = base64Decode(base64DivHtml).replace('__CSS_FONT_FAMILY__', CSS_FONT_FAMILY).replace('__EMOJIS__', EMOJIS.map((emoji) => `<text x="32" y="32" class="svgrect-emoji">${emoji}</text>`).join(''));
            patch(divElement, html `${divHtml}`);
            // SVG
    ...
    async function getCanvasWebgl() {
        ...
        try {
            ...
            const lied = (dataLie ||
                ...
                lieProps['WebGL2RenderingContext.getSupportedExtensions']) ? true : false;
            // create canvas context
            let win = window;
            if (!LIKE_BRAVE && PHANTOM_DARKNESS) {
                win = PHANTOM_DARKNESS;
        ...
        return await new Promise(function (resolve, reject) {
            ...
            function storageQuotaChromePrivateTest() {
                navigator.webkitTemporaryStorage.queryUsageAndQuota(function (_, quota) {
                    ...
                    reject(new Error("getIncognitoStatus failed to query storage quota: " + e.message));
                });
            }
            ...
            function main() {
                if (isSafari()) {
                    ...
                    reject(new Error("getIncognitoStatus cannot determine the browser"));
                }
            }
            main();
        });
    ...
    function chromiumDevTools() {
        ...
        var r = false;
        if (window.chrome) {
            var o = (1e3 * e["Math"]["random"]()) | 0, i = (1e3 * e["Math"]["random"]()) | 0, a = o;
            try {
                var s = new e.Error(), d = {};
    ...
    async function firefoxDevTools() {
        return new Promise((resolve) => {
            new Promise((r) => r()).then(() => {
                try {
                    ...
                    return resolve(/callback\*/.test(e?.stack?.toString?.() || ""));
                }
                return resolve(true);
            });
        });
    }
    async function getDevtoolStatus() {
        let status = false;
        if (IS_BLINK) {
            return await chromiumDevTools();
        }
        if (IS_GECKO) {
            return await firefoxDevTools();
        }
        return status;
    }

    const base = "https://test-api.browsify.net";
    const templateBlocked = (template) => {
        let title = `Access Denied`;
        let description = `The site owner may have set restrictions that prevent you from accessing the site. Please contact the site owner for access.`;
        let image = `https://apps-shopify.ipblocker.io/s/api/public/assets/default-thumbnail.png`;
        const ele = document.querySelector("body");
        if (!ele)
            return;
        if (template && template.html) {
            ele.innerHTML = template.html;
            return;
        }
        if (template && template.title) {
            ...
            if (template.image) {
                image = template.image.startsWith("http") ? template.image : `${base}/upload/${template.image}`;
            }
        }
        const templateDefault = `<div id="blockify---container" style="--bg-blockify: #fff;font-family: Montserrat, sans-serif;font-size: 16px !important;position: fixed !important;z-index: 999999 !important;display: flex;flex-direction: column;align-items: center;justify-content: center;padding: 1.2rem;inset: 0;width: 100vw;height: 100vh;"><div id="blockify---container__inner" style="
    text-align: center;
"><img src="${image}" style="
    position: relative;
    max-width: 200px;
    height: auto;
"><div id="blockify-block-content"><div id="blockify-block-title" style="color: rgb(0, 0, 0);font-size: 40px !important;font-weight: bold;margin-top: 1em;text-align: center;">${title}</div><div id="blockify-block-description" style="color: rgb(0, 0, 0);font-size: 18px !important;margin: 1em 0.5em;line-height: 1.5;text-align: center;">${description}</div></div></div></div>`;
        ele.innerHTML = templateDefault;
    };
    const disableAction = (data = null) => {
        if (!data || (data && data.block_copy_enabled)) {
            document.onselectstart = new Function("return false"); // Copy
        }
        else {
            document.onselectstart = null;
        }
        if (!data || (data && data.block_inspect_enabled)) {
            let ctrlKeys = ["U"];
            if (!data || (data && data.block_copy_enabled)) {
                ctrlKeys = ["S", "X", "A", "C", "U", "F"];
            }
            document.onkeydown = (e) => {
                const key = e.key.toUpperCase();
                if (e.key === "F12" ||
                    (e.ctrlKey && e.shiftKey && ["I", "C", "J"].includes(key)) ||
                    (e.ctrlKey && ctrlKeys.includes(key))) {
                    e.preventDefault();
                }
            };
        }
        else if (data && data.block_copy_enabled) {
            document.onkeydown = (e) => {
                const key = e.key.toUpperCase();
                if (e.ctrlKey && ["S", "X", "A", "C", "U", "F"].includes(key)) {
                    e.preventDefault();
                }
            };
        }
        ...
        if (!data || (data && data.block_right_click_enabled)) {
            document.oncontextmenu = new Function("return false"); // Right click
        }
        else {
            document.oncontextmenu = null;
        }
    };
    const detectFingerprint = async (secret) => {
        return await fetch(`${base}/fp?token=${await hashify(secret)}`, {
            method: "POST",
            headers: {
    ...
    !(async function () {
        const factors = localStorage.getItem("factors") ?? null;
        if (factors)
            JSON.parse(factors);
        const addCart = localStorage.getItem("add_cart") ?? null;
        if (addCart)
            JSON.parse(addCart);
        disableAction();
        await queueTask();
        const stackBytes = getStackBytes();
        const [, measuredTime, ttfb, sQuota] = await Promise.all([
            exile(),
            measure(),
            getTTFB(),
            getStorage(),
        ]);
        const measured = outerWidth - innerWidth < 150 && outerHeight - innerHeight < 150
            ? measuredTime
            : 0;
        ...
        const fingerprint = async () => {
            const [voicesComputed, offlineAudioContextComputed, canvasWebglComputed, canvas2dComputed, windowFeaturesComputed, htmlElementVersionComputed, cssComputed, cssMediaComputed, screenComputed, mathsComputed, consoleErrorsComputed, timezoneComputed, clientRectsComputed, fontsComputed, mediaComputed, svgComputed, resistanceComputed, intlComputed, incognitoStatus, devtoolStatus,] = await Promise.all([
                getVoices(),
            ...
            const navigatorComputed = await getNavigator().catch((error) => console.error(error.message));
            ...
            // Hashing
            const [windowHash, headlessHash, htmlHash, cssMediaHash, cssHash, styleHash, styleSystemHash, screenHash, voicesHash, canvas2dHash, canvas2dImageHash, canvas2dPaintHash, canvas2dTextHash, canvas2dEmojiHash, canvasWebglHash, canvasWebglImageHash, canvasWebglParametersHash, pixelsHash, pixels2Hash, mathsHash, consoleErrorsHash, timezoneHash, rectsHash, domRectHash, audioHash, fontsHash, mediaHash, navigatorHash, liesHash, trashHash, errorsHash, svgHash, resistanceHash, intlHash, featuresHash,] = await Promise.all([
        ...
        const { maths, consoleErrors, htmlElementVersion, windowFeatures, clientRects, offlineAudioContext, resistance, canvas2d, canvasWebgl, screen: screenFp, svg, devtools, incognito, headless, navigator, lies, fonts, } = fp;
        ...
        const screenMetrics = !screenFp || isRFP || isTorBrowser
            ? "undefined"
        ...
        const getBestGPUModel = ({ canvasWebgl }) => {
            const gpuHasGoodConfidence = (data) => {
                return (data.gpu || {}).confidence && data.gpu.confidence != "low";
            };
            if (!canvasWebgl) {
                return "undefined";
            }
            else if (canvasWebgl && gpuHasGoodConfidence(canvasWebgl)) {
                return "" + (canvasWebgl.parameters || {}).UNMASKED_RENDERER_WEBGL;
            }
            return "undefined";
        };
        const gpuModel = getBestGPUModel({ canvasWebgl });
        const sender = {
            e: {
        ...
        let platformEstimate = undefined;
        if (headless &&
            headless.platformEstimate &&
            headless.platformEstimate.length > 0 &&
            headless.platformEstimate[0]) {
            const keys = Object.keys(headless.platformEstimate[0]);
            platformEstimate = keys[0];
            for (let i = 0; i < keys.length; i++) {
                if (headless.platformEstimate[0][keys[i]] >
                    headless.platformEstimate[0][platformEstimate]) {
                    platformEstimate = keys[i];
                }
            }
        }
        if (!window.Shopify || !window.Shopify.shop) {
            console.log("!window.Shopify || !window.Shopify.shop");
            return;
        }
        const RAW_BODY = {
            aa: stackBytes,
            ...
            ad: ttfb,
            ae: sQuota,
            af: `${sender.e}_${sender.l}`,
            ag: resistance.$hash,
            ah: maths.$hash,
            ai: consoleErrors.$hash,
            aj: htmlElementVersion.$hash,
            ak: windowFeatures.$hash,
            al: styleHash,
            am: styleSystemHash,
            an: clientRects.domrectSystemSum,
            ao: domRectHash,
            ap: svg.svgrectSystemSum,
            aq: audioMetrics,
            ar: canvas2dImageHash,
            as: canvas2dPaintHash,
            at: canvas2dTextHash,
            au: canvas2dEmojiHash,
            av: canvas2d.textMetricsSystemSum,
            aw: canvasWebglImageHash,
            ax: canvasWebglParametersHash,
            ay: gpuModel,
            az: screenMetrics,
            ba: devtools,
            bb: incognito,
            bc: {
                // headless
                a: headless.headlessRating,
                b: platformEstimate, // platformEstimate
            },
            bd: {
                // navigator
                a: navigator.userAgent,
                b: navigator.system,
                c: navigator.userAgentParsed,
                d: navigator.device,
                e: navigator.deviceMemory,
                f: navigator.hardwareConcurrency,
                g: navigator.maxTouchPoints,
                h: navigator.doNotTrack ? navigator.doNotTrack : "null",
                i: navigator.platform,
                j: navigator.bluetoothAvailability,
                k: {
                    // userAgentData
                    a: navigator.userAgentData && navigator.userAgentData.platform
                        ? navigator.userAgentData.platform
                        : "",
                    b: navigator.userAgentData && navigator.userAgentData.platformVersion
                        ? navigator.userAgentData.platformVersion
                        : "",
                    c: navigator.userAgentData && navigator.userAgentData.uaFullVersion
                        ? navigator.userAgentData.uaFullVersion
                        : "",
                    d: navigator.userAgentDataBrands ? navigator.userAgentDataBrands : "", // brands
                },
            },
            be: {
                // fonts
                a: fonts.platformVersion, // platformVersion
            },
            bf: {
                a: Boolean(clientRects.lied),
                b: Boolean(svg.lied),
                c: Boolean(offlineAudioContext.lied),
                d: Boolean(canvas2d.lied),
                e: Boolean(canvasWebgl.lied),
                f: lies.totalLies, // totalLies
            },
            bg: Date.now(),
            bh: window.location.host,
            bi: window.bid ? window.bid : "",
            bj: window.Shopify.shop,
            bk: getSessionID(),
        };
        const [xClientID, secret] = await Promise.all([
            hashify({
                aa: audioMetrics,
                ab: canvas2dImageHash,
                ac: canvas2dPaintHash,
                ad: canvas2dTextHash,
                ae: canvas2dEmojiHash,
                af: canvas2d.textMetricsSystemSum,
                ag: canvasWebglImageHash,
                ah: canvasWebglParametersHash,
                ai: gpuModel,
                aj: screenMetrics,
                ak: navigator.system,
                al: navigator.device,
                am: navigator.deviceMemory ? navigator.deviceMemory : 0,
                an: navigator.hardwareConcurrency,
                ao: navigator.maxTouchPoints,
                ap: navigator.doNotTrack ? navigator.doNotTrack : "null",
                aq: navigator.platform,
            }),
            cipher(RAW_BODY),
        ]);
        const resultFp = await detectFingerprint(secret);
        console.log(resultFp);
        if (resultFp && resultFp.status == "success") {
            disableAction(resultFp);
        }
        else if (resultFp && resultFp.message.startsWith("Blocked")) {
            templateBlocked(resultFp.template);
            if (resultFp.redirect_url) {
                window.open(resultFp.redirect_url, "_self");
            }
        }
        else {
            // request lỗi
            disableAction({
                block_copy_enabled: false,
                block_inspect_enabled: false,
                block_right_click_enabled: false,
            });
        }
    })();
